...
clc; 
close all;
addpath("/Users/kexinwang/Documents/CEST/StrokeGAMT/Github_shared/9.4T/codes/toolbox");
datapath_pwr = '/Users/kexinwang/Documents/CEST/StrokeGAMT/Github_shared/9.4T/data';
%   Load the frequency list: 73 offsets
% load('path-to-data/crlist.mat');
load('/Users/kexinwang/Documents/CEST/StrokeGAMT/Github_shared/9.4T/data/crlist.mat');
%   Load the mask of mouse brain
% load('path-to-data/mask.mat');
load('/Users/kexinwang/Documents/CEST/StrokeGAMT/Github_shared/9.4T/data/mask.mat');
%   Load the CEST images of a B1 of 0.8uT
% load('path-to-data/cestimgs.mat');
load('/Users/kexinwang/Documents/CEST/StrokeGAMT/Github_shared/9.4T/data/cestimgs.mat');
%   Load the T1 map
% load('path-to-data/T1map.mat');
load('/Users/kexinwang/Documents/CEST/StrokeGAMT/Github_shared/9.4T/data/T1map.mat');
