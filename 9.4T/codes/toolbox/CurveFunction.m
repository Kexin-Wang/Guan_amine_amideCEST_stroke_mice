...
%       x(5~7) for peak_1;   x(8~10) for peak_2; x(11~13) for peak_3;   ...
%
...
%           Rexch_peak_3, width_peak_3, center_peak_3, ...]
%
...
%           = 4: only backgound and peak_3 are used for the fitting;
%           ...
%
%------------ Output------------%
% 
...
Ramine = x(8)*x(9)^2./( x(9)^2 + 4*(xdata - x(10)).^2 );
Rguan = x(11)*x(12)^2./( x(12)^2 + 4*(xdata - x(13)).^2 );
